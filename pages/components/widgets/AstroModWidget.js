				...
				<div className="custom-img">
					...
					>
						<div id="oneAM" style={{ display: num === 1 ? 'block' : 'none' }}>
							{console.log(productColors.filter((color) => color === prodColor))}
							<CustomImages
								name={productID}
			...
			<div className="input-group">
				<table>
					<tbody>
							...
							<td>
								<Box sx={{ width: 300 }}>
									<FormControl fullWidth style={formStyles}>
										<InputLabel id="color-select-label" style={formStyles}>
											Color
										</InputLabel>
										<Select
						...
						{/* <tr className="custom-logo-div" id="upload-logo-oneAS" style="height: 150px;">
							<th>Upload Logo:</th>
							<td>
								<p>
									<input
						...
						<tr style="height: 50px;">
							...
							<td>
								<div className="custom-text-div" id="input-text-oneAS">
									<input
										type="text"
										id="custom-text-oneAS"
										maxLength="15"
										placeholder="Less than 15 characters"
										onInput="onTextInputOne()"
									/>
								</div>
								<div className="custom-text-div" id="input-text-threeAS">
									<input
										type="text"
										id="custom-text-threeAS"
										maxLength="15"
										placeholder="Less than 15 characters"
										onInput="onTextInputThree()"
									/>
								</div>
								<div className="custom-text-div" id="input-text-fiveAS">
									<input
										type="text"
										id="custom-text-fiveAS"
										maxLength="15"
										placeholder="Less than 15 characters"
										onInput="onTextInputFive()"
									/>
								</div>
								<div className="custom-text-div" id="input-text-sevenAS">
									<input
										type="text"
										id="custom-text-sevenAS"
										maxLength="15"
										placeholder="Less than 15 characters"
										onInput="onTextInputSeven()"
									/>
								</div>
								<input type="color" id="pickerAS" name="picker" value="#808080" />
							</td>
						</tr>
						<tr>
							<th>Need Custom User Manual? </th>
							<td style="padding-left: 1em; vertical-align: middle;">
								<input type="radio" id="manual-yesAS" name="manual" value="manual-yes" />
								<label htmlFor="manual-yes">Yes</label>
								<input type="radio" id="manual-noAS" name="manual" value="manual-no" />
						...
						<tr>
							...
							<td style="padding-left: 1em; vertical-align: middle;">
								<input type="radio" id="package-yesAS" name="package" value="package-yes" />
								<label htmlFor="package-yes">Yes</label>
								<input type="radio" id="package-noAS" name="package" value="package-no" />
